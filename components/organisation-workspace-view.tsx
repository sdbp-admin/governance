...
export function OrganisationWorkspaceView({workspace,currentUserId,canInvite,personName,onInvite,onSaveRole,onDeleteRole,onOpenProject}:{workspace:WorkspaceData;currentUserId:string;canInvite:boolean;personName:(id:string)=>string;onInvite:(name:string,email:string)=>Promise<boolean>;onSaveRole:(role:RoleDefinition)=>Promise<boolean>;onDeleteRole:(id:string)=>Promise<boolean>;onOpenProject:(id:string)=>void}){
