  ...
  return <div className="modal-backdrop" onMouseDown={(event) => { if (event.target === event.currentTarget) onClose(); }}>
    <section className="workflow-editor compact-modal project-context-modal" role="dialog" aria-modal="true">
      ...
      <div className="project-coi-settings">
        <div className="project-coi-settings-head"><div><strong>Conflict of interest</strong><p>Attach a COI to a person when an outside interest can affect this project. The project stays visible; file and link contents are protected from that person. Visible comments and titles remain the board&apos;s responsibility.</p></div>{!coiFormOpen && availablePeople.length > 0 && <button className="secondary small" type="button" onClick={() => setCoiFormOpen(true)}>+ Declare COI</button>}</div>
